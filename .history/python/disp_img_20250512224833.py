...
def display_nifti_slice(file_path, slice_index=0):
    ...
    # Display the slice
# If the data has multiple channels, select the first channel
slice_2d = data[:, :, slice_index]
if slice_2d.ndim == 3:  # If the slice has multiple channels
    slice_2d = slice_2d[:, :, 0]  # Select the first channel
