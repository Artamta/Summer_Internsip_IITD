...
# To display parameter maps FOR SIMULATION datq use the color range,
# D: 0 - 0.003
# DSTAR: 0 -0.03
# f: 0 - 0.3
# k: 0 - 3
...
ref_img = nib.load("/Users/ayush/Desktop/project-internsip/reference_maps/Simulation-II_Dstar_map.nii")

# Load simulated IVIM-DKI data
ref_data = nib.load("/Users/ayush/Desktop/project-internsip/Simulation data/Simulation-II_Nifty-data/Simulation-II_SNR40/Data-5_Simulation-II_SNR-40.nii")

# Load estimated Parametric map for advanced model IDTV
est_img_d_tv = nib.load("/Users/ayush/Desktop/project-internsip/new_output/simulation2/snr40/Output_Parameter_Maps/Data-5_Simulation-II_SNR-40_D.nii")
est_img_dstar_tv = nib.load("/Users/ayush/Desktop/project-internsip/new_output/simulation2/snr40/Output_Parameter_Maps/Data-5_Simulation-II_SNR-40_D_star.nii")
est_img_f_tv = nib.load("/Users/ayush/Desktop/project-internsip/new_output/simulation2/snr40/Output_Parameter_Maps/Data-5_Simulation-II_SNR-40_f.nii")
est_img_k_tv = nib.load("/Users/ayush/Desktop/project-internsip/new_output/simulation2/snr40/Output_Parameter_Maps/Data-5_Simulation-II_SNR-40_k.nii")
...
est_prm_tv = est_dstar_tv # change this for different simulations
...
# print("Reference min/max:", np.min(ref_prm), np.max(ref_prm))
# print("Estimated min/max:", np.min(est_prm_tv), np.max(est_prm_tv))
...
plt.subplot(1, 2, 2)
plt.imshow(est_prm_tv[:, :, mid_slice], cmap='jet', vmin=0, vmax=0.03)
